...
SETUP_STEPS = (
    ...
    "  4. Copy it, then run ONE of these -- do not type the cookie at a\n"
    "     prompt, the terminal truncates a line at 1024 characters and the\n"
    "     header is ~3x that, which looks like a hang:\n"
